...
static bool
_equalCreateClassStmt(const CreateClassStmt *a, const CreateClassStmt *b)
{
	COMPARE_NODE_FIELD(relation);
	COMPARE_NODE_FIELD(tableElts);
	COMPARE_NODE_FIELD(inhRelations);
...
static bool
_equalCreateDeputyClassStmt(const CreateDeputyClassStmt *a, const CreateDeputyClassStmt *b)
{
	COMPARE_NODE_FIELD(classname);
	COMPARE_SCALAR_FIELD(isPrecise);
	COMPARE_NODE_FIELD(realattrs);
	COMPARE_NODE_FIELD(methods);
	COMPARE_NODE_FIELD(deputyRule);
	COMPARE_NODE_FIELD(createstmt);
	COMPARE_SCALAR_FIELD(dkind);
	COMPARE_NODE_FIELD(writeExprs);
	COMPARE_SCALAR_FIELD(tablespacename);
	COMPARE_SCALAR_FIELD(deputy_desc);
...
equal(const void *a, const void *b)
{
	...
	switch (nodeTag(a))
	{
		...
		case T_CreateClassStmt:
			retval = _equalCreateClassStmt(a, b);
			break;
		case T_CreateDeputyClassStmt:
			retval = _equalCreateDeputyClassStmt(a, b);
			break;
